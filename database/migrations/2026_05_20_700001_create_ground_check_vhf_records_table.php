...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_check_vhf_records', function (Blueprint $table) {
            $table->id();
            $table->string('form_number')->unique();
            $table->string('form_type')->default('GC-VHF');
            $table->string('report_month')->nullable();
            $table->string('airport')->default('JUANDA SURABAYA');
            $table->string('equipment_name')->default('VHF');
        ...
        DB::statement("
            ...
            ON ground_check_vhf_records (form_type, date, shift_type)
    ...
    {
        Schema::dropIfExists('ground_check_vhf_records');
    }
};
