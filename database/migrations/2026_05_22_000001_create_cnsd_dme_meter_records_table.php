...
return new class extends Migration
{
    ...
    {
        Schema::create('cnsd_dme_meter_records', function (Blueprint $table) {
            $table->id();
            $table->string('form_number')->unique();
            $table->string('form_type')->default('DME-METER');
            $table->string('facility')->default('DME');
        ...
        DB::statement(
            'CREATE UNIQUE INDEX cnsd_dme_meter_records_unique_form_per_shift
             ON cnsd_dme_meter_records (form_type, facility, date, shift_type)
    ...
    {
        Schema::dropIfExists('cnsd_dme_meter_records');
    }
};
