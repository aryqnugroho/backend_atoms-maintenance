...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_check_gp_technicians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('ground_check_gp_record_id', 'gcg_tech_record_fk')
                ->references('id')
    ...
    {
        Schema::dropIfExists('ground_check_gp_technicians');
    }
};
