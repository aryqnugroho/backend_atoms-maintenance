...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_check_vhf_technicians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('ground_check_vhf_record_id', 'gcv_tech_record_fk')
                ->references('id')
    ...
    {
        Schema::dropIfExists('ground_check_vhf_technicians');
    }
};
