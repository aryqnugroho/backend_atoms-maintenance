...
return new class extends Migration
{
    ...
    {
        Schema::create('cnsd_atc_system_meter_technicians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('atc_system_meter_record_id', 'cnsd_atc_sys_tech_record_fk')
    ...
    {
        Schema::dropIfExists('cnsd_atc_system_meter_technicians');
    }
};
