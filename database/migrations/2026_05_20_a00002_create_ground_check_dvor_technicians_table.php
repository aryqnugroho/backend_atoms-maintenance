...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_check_dvor_technicians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('ground_check_dvor_record_id', 'gcd_tech_record_fk')
                ->references('id')
    ...
    {
        Schema::dropIfExists('ground_check_dvor_technicians');
    }
};
