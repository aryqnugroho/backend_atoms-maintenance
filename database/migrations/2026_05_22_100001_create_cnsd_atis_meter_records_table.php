...
return new class extends Migration
{
    ...
    {
        Schema::create('cnsd_atis_meter_records', function (Blueprint $table) {
            $table->id();
            $table->string('form_number')->unique();
            $table->string('form_type')->default('ATIS-METER');
            $table->string('facility')->default('ATIS');
        ...
        DB::statement(
            'CREATE UNIQUE INDEX cnsd_atis_meter_records_unique_form_per_shift
             ON cnsd_atis_meter_records (form_type, facility, date, shift_type)
    ...
    {
        Schema::dropIfExists('cnsd_atis_meter_records');
    }
};
