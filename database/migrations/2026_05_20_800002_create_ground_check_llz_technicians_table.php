...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_check_llz_technicians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('ground_check_llz_record_id', 'gcl_tech_record_fk')
                ->references('id')
    ...
    {
        Schema::dropIfExists('ground_check_llz_technicians');
    }
};
