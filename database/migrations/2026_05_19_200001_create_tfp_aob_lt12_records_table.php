...
/**
 * tfp_aob_lt12_records — header table for TFP Performance Check AOB Lantai 1 & 2 forms.
 *
...
return new class extends Migration {
    ...
    {
        Schema::create('tfp_aob_lt12_records', function (Blueprint $table) {
            $table->id();

            // Identity
            $table->string('form_number', 80)->unique();
            $table->string('form_type', 30)->default('AOB-LT12');
            ...
            $table->string('location', 100)->default('AOB LANTAI 1 & 2');
        ...
        \Illuminate\Support\Facades\DB::statement(
            'CREATE UNIQUE INDEX tfp_aob_lt12_records_unique_form_per_shift '
            . 'ON tfp_aob_lt12_records (form_type, date, shift_type) '
    ...
    {
        \Illuminate\Support\Facades\DB::statement(
            'DROP INDEX IF EXISTS tfp_aob_lt12_records_unique_form_per_shift'
        );
        Schema::dropIfExists('tfp_aob_lt12_records');
    }
};
