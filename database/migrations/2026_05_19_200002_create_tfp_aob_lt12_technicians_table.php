...
/**
 * tfp_aob_lt12_technicians — one row per TFP technician on duty for a given
 * AOB Lantai 1 & 2 record. Technician signatures live here (not on the header record).
 */
return new class extends Migration {
    public function up(): void
    {
        Schema::create('tfp_aob_lt12_technicians', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tfp_aob_lt12_technicians');
    }
};
