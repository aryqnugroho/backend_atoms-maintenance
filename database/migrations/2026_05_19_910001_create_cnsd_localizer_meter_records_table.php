...
return new class extends Migration
{
    ...
    {
        Schema::create('cnsd_localizer_meter_records', function (Blueprint $table) {
            $table->id();
            $table->string('form_number')->unique();
            $table->string('form_type')->default('LOCALIZER-METER');
            $table->string('facility')->default('ILS LOCALIZER');
            $table->string('form_code')->default('ILS-LLZ');
        ...
        DB::statement(
            'CREATE UNIQUE INDEX cnsd_localizer_meter_records_unique_form_per_shift
             ON cnsd_localizer_meter_records (form_type, facility, date, shift_type)
    ...
    {
        Schema::dropIfExists('cnsd_localizer_meter_records');
    }
};
