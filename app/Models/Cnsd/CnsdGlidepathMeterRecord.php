...
class CnsdGlidepathMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_glidepath_meter_records';
    ...
    {
        return $this->hasMany(CnsdGlidepathMeterTechnician::class, 'glidepath_meter_record_id')
            ->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdGlidepathMeterItem::class, 'glidepath_meter_record_id')
            ->orderBy('sort_order');
    }
