...
class CnsdAtcSystemMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_atc_system_meter_records';
    ...
    {
        return $this->hasMany(CnsdAtcSystemMeterTechnician::class, 'atc_system_meter_record_id')->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdAtcSystemMeterItem::class, 'atc_system_meter_record_id')->orderBy('sort_order');
    }
