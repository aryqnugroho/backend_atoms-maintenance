...
class CnsdAtcSystemMeterTechnician extends Model
{
    protected $table = 'cnsd_atc_system_meter_technicians';

    protected $fillable = [
        'atc_system_meter_record_id', 'technician_id', 'technician_name',
