...
class CnsdDmeMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_dme_meter_records';
    ...
    {
        return $this->hasMany(CnsdDmeMeterTechnician::class, 'dme_meter_record_id')->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdDmeMeterItem::class, 'dme_meter_record_id')->orderBy('sort_order');
    }
