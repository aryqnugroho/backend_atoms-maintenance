...
class CnsdDvorMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_dvor_meter_records';
    ...
    {
        return $this->hasMany(CnsdDvorMeterTechnician::class, 'dvor_meter_record_id')->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdDvorMeterItem::class, 'dvor_meter_record_id')->orderBy('sort_order');
    }
