...
/**
 * CnsdAsmgcsMeterRecord — header for one CNSD ASMGCS Meter Reading (SAAB).
 */
class CnsdAsmgcsMeterRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'cnsd_asmgcs_meter_records';
    ...
    public const FACILITIES  = ['ASMGCS'];
    public const FORM_TYPES  = ['ASMGCS-METER'];
    ...
    {
        return $this->hasMany(CnsdAsmgcsMeterTechnician::class, 'asmgcs_meter_record_id')
            ->orderBy('sort_order')->orderBy('id');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdAsmgcsMeterItem::class, 'asmgcs_meter_record_id')
            ->orderBy('sort_order')->orderBy('id');
    }
