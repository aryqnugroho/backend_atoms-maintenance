...
class CnsdAtisMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_atis_meter_records';
    ...
    {
        return $this->hasMany(CnsdAtisMeterTechnician::class, 'atis_meter_record_id')->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdAtisMeterItem::class, 'atis_meter_record_id')->orderBy('sort_order');
    }
