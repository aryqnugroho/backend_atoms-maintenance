...
class CnsdLocalizerMeterRecord extends Model
{
    use SoftDeletes, HasSignature;

    protected $table = 'cnsd_localizer_meter_records';
    ...
    {
        return $this->hasMany(CnsdLocalizerMeterTechnician::class, 'localizer_meter_record_id')->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(CnsdLocalizerMeterItem::class, 'localizer_meter_record_id')->orderBy('sort_order');
    }
