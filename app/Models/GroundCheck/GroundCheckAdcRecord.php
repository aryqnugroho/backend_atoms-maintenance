...
class GroundCheckAdcRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'ground_check_adc_records';
    ...
    {
        return $this->hasMany(GroundCheckAdcTechnician::class, 'ground_check_adc_record_id')
            ->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(GroundCheckAdcItem::class, 'ground_check_adc_record_id')
            ->orderBy('sort_order');
    }
