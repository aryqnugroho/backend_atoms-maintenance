...
class GroundCheckGpRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'ground_check_gp_records';
    ...
    {
        return $this->hasMany(GroundCheckGpTechnician::class, 'ground_check_gp_record_id')
            ->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(GroundCheckGpItem::class, 'ground_check_gp_record_id')
            ->orderBy('sort_order');
    }

    public function navItems(): HasMany
    {
        return $this->hasMany(GroundCheckGpNavItem::class, 'ground_check_gp_record_id')
            ->orderBy('sort_order');
    }

    public function photos(): HasMany
    {
        return $this->hasMany(GroundCheckGpPhoto::class, 'ground_check_gp_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
