...
class GroundCheckLlzRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'ground_check_llz_records';
    ...
    {
        return $this->hasMany(GroundCheckLlzTechnician::class, 'ground_check_llz_record_id')
            ->orderBy('sort_order');
    }

    public function items(): HasMany
    {
        return $this->hasMany(GroundCheckLlzItem::class, 'ground_check_llz_record_id')
            ->orderBy('sort_order');
    }

    public function curvePoints(): HasMany
    {
        return $this->hasMany(GroundCheckLlzCurvePoint::class, 'ground_check_llz_record_id')
            ->orderBy('sort_order');
    }

    public function photos(): HasMany
    {
        return $this->hasMany(GroundCheckLlzPhoto::class, 'ground_check_llz_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
