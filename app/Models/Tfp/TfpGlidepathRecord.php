...
class TfpGlidepathRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'tfp_glidepath_records';
    ...
    {
        return $this->hasMany(TfpGlidepathTechnician::class, 'glidepath_record_id')->orderBy('sort_order')->orderBy('id');
    }
    public function items(): HasMany
    {
        return $this->hasMany(TfpGlidepathItem::class, 'glidepath_record_id')->orderBy('sort_order')->orderBy('id');
    }
    public function facilities(): HasMany
    {
        return $this->hasMany(TfpGlidepathFacility::class, 'glidepath_record_id')->orderBy('sort_order')->orderBy('id');
    }
