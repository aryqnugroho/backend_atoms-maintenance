...
class TfpGlidepathTechnician extends Model
{
    protected $table = 'tfp_glidepath_technicians';
    protected $fillable = ['glidepath_record_id', 'technician_id', 'technician_name', 'technician_signature', 'technician_signed_by', 'technician_signed_at', 'sort_order'];
