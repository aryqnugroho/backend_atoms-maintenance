...
class TfpLocalizerRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'tfp_localizer_records';
    ...
    {
        return $this->hasMany(TfpLocalizerTechnician::class, 'localizer_record_id')->orderBy('sort_order')->orderBy('id');
    }
    public function items(): HasMany
    {
        return $this->hasMany(TfpLocalizerItem::class, 'localizer_record_id')->orderBy('sort_order')->orderBy('id');
    }
    public function facilities(): HasMany
    {
        return $this->hasMany(TfpLocalizerFacility::class, 'localizer_record_id')->orderBy('sort_order')->orderBy('id');
    }
