...
class TfpTowerRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'tfp_tower_records';
    ...
    {
        return $this->hasMany(TfpTowerTechnician::class, 'tower_record_id')->orderBy('sort_order')->orderBy('id');
    }

    public function items(): HasMany
    {
        return $this->hasMany(TfpTowerItem::class, 'tower_record_id')->orderBy('sort_order')->orderBy('id');
    }

    public function facilities(): HasMany
    {
        return $this->hasMany(TfpTowerFacility::class, 'tower_record_id')->orderBy('sort_order')->orderBy('id');
    }
