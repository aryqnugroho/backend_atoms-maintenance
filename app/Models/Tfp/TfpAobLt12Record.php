...
/**
 * TfpAobLt12Record — header for one TFP Performance Check AOB Lantai 1 & 2 form.
 *
...
class TfpAobLt12Record extends Model
{
    ...
    public const FORM_TYPES  = ['AOB-LT12'];
    ...
    {
        return $this->hasMany(TfpAobLt12Technician::class, 'aob_lt12_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
    ...
    {
        return $this->hasMany(TfpAobLt12Item::class, 'aob_lt12_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
    ...
    {
        return $this->hasMany(TfpAobLt12Facility::class, 'aob_lt12_record_id')
            ->orderBy('sort_order')
            ->orderBy('id');
    }
