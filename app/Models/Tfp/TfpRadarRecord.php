...
class TfpRadarRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'tfp_radar_records';
    ...
    {
        return $this->hasMany(TfpRadarTechnician::class, 'radar_record_id')->orderBy('sort_order')->orderBy('id');
    }

    public function items(): HasMany
    {
        return $this->hasMany(TfpRadarItem::class, 'radar_record_id')->orderBy('sort_order')->orderBy('id');
    }

    public function facilities(): HasMany
    {
        return $this->hasMany(TfpRadarFacility::class, 'radar_record_id')->orderBy('sort_order')->orderBy('id');
    }
