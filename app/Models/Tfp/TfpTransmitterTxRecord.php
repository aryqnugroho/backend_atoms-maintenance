...
class TfpTransmitterTxRecord extends Model
{
    use HasSignature, SoftDeletes;

    protected $table = 'tfp_transmitter_tx_records';
    ...
    {
        return $this->hasMany(TfpTransmitterTxTechnician::class, 'tx_record_id')
            ->orderBy('sort_order')->orderBy('id');
    }

    public function items(): HasMany
    {
        return $this->hasMany(TfpTransmitterTxItem::class, 'tx_record_id')
            ->orderBy('sort_order')->orderBy('id');
    }

    public function facilities(): HasMany
    {
        return $this->hasMany(TfpTransmitterTxFacility::class, 'tx_record_id')
            ->orderBy('sort_order')->orderBy('id');
    }
