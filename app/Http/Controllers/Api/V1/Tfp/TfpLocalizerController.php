    ...
    private function detailRecord(TfpLocalizerRecord $r): array
    {
        ...
        return [
            ...
            'items' => $r->items->map(fn ($it) => [
                ...
                'panel_lz01' => $it->panel_lz01,
                'panel_cos_lz02_input' => $it->panel_cos_lz02_input, 'panel_cos_lz02_output' => $it->panel_cos_lz02_output,
                'panel_lz03' => $it->panel_lz03,
                'panel_cos_lz04_input' => $it->panel_cos_lz04_input, 'panel_cos_lz04_output' => $it->panel_cos_lz04_output,
                'panel_mlat_ru04' => $it->panel_mlat_ru04,
