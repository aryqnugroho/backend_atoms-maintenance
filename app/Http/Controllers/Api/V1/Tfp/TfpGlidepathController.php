...
class TfpGlidepathController extends Controller
{
    ...
    private function detailRecord(TfpGlidepathRecord $r): array
    {
        ...
        return [
            ...
            'items' => $r->items->map(fn ($it) => ['id' => $it->id, 'parameter_number' => $it->parameter_number, 'parameter_name' => $it->parameter_name, 'unit' => $it->unit, 'panel_gp01' => $it->panel_gp01, 'is_disabled_map' => $it->is_disabled_map, 'sort_order' => $it->sort_order])->values()->toArray(),
