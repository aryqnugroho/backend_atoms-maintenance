...
class GroundCheckAdcController extends Controller
{
    public function __construct(
        protected GroundCheckAdcService $service,
    ) {}

    /**
     * GET /api/v1/ground-check/adc
     */
    public function index(Request $request): JsonResponse
    {
        ...
        $items = $records->getCollection()->map(function (GroundCheckAdcRecord $r) {
            return [
                'id'               => $r->id,
    ...
    /**
     * GET /api/v1/ground-check/adc/years
     */
    public function years(): JsonResponse
    {
        $years = GroundCheckAdcRecord::query()
    ...
    /**
     * GET /api/v1/ground-check/adc/template
     */
    public function template(): JsonResponse
    {
        return response()->json([
            'success' => true,
            'data'    => [
                'items' => GroundCheckAdcTemplate::items(),
            ],
        ]);
    }

    /**
     * POST /api/v1/ground-check/adc
     */
    public function store(CreateGroundCheckAdcRequest $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Ground Check ADC berhasil dibuat.',
    ...
    /**
     * GET /api/v1/ground-check/adc/{id}
     */
    ...
    /**
     * PUT /api/v1/ground-check/adc/{id}
     */
    public function update(UpdateGroundCheckAdcRequest $request, int $id): JsonResponse
    {
    ...
    /**
     * POST /api/v1/ground-check/adc/{id}/sign
     */
    public function sign(SignGroundCheckAdcRequest $request, int $id): JsonResponse
    {
        $record = GroundCheckAdcRecord::with('technicians')->find($id);
    ...
    /**
     * DELETE /api/v1/ground-check/adc/{id}
     */
    ...
    private function formatDetail(GroundCheckAdcRecord $record): array
    {
        return [
            'id'                   => $record->id,
